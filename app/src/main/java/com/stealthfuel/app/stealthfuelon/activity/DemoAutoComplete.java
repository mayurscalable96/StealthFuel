...
public class DemoAutoComplete extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_auto_complete);
        mGoogleApiClient = new GoogleApiClient.Builder(DemoAutoComplete.this)
